...
typedef struct zfs_cmd {
	...
	kuintcap64_t	zc_nvlist_src;		/* really (char *) */
	uint64_t	zc_nvlist_src_size;
	kuintcap64_t	zc_nvlist_dst;		/* really (char *) */
	 ...
	 */
	kuintcap64_t	zc_history;		/* really (char *) */
	char		zc_value[MAXPATHLEN * 2];
	char		zc_string[MAXNAMELEN];
	uint64_t	zc_guid;
	kuintcap64_t	zc_nvlist_conf;		/* really (char *) */
